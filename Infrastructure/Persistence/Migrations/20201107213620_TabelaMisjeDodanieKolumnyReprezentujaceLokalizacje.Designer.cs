...
namespace FocusOnFlying.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20201107213620_TabelaMisjeDodanieKolumnyReprezentujaceLokalizacje")]
    partial class TabelaMisjeDodanieKolumnyReprezentujaceLokalizacje
    {
            ...
            modelBuilder.Entity("FocusOnFlying.Domain.Entities.FocusOnFlyingDb.Misja", b =>
                {
                    ...
                    b.Property<string>("NazwaLokalizacji")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
