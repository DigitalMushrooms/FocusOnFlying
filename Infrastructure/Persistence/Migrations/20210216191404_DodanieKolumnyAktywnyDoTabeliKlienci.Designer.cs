...
namespace FocusOnFlying.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20210216191404_DodanieKolumnyAktywnyDoTabeliKlienci")]
    partial class DodanieKolumnyAktywnyDoTabeliKlienci
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FocusOnFlying.Domain.Entities.FocusOnFlyingDb.Audyt", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                    ...
                    b.Property<Guid>("IdAudytowanegoWiersza")
                        .HasColumnType("uniqueidentifier");

                    b.Property<string>("NazwaTabeli")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("TypOperacji")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("FocusOnFlying.Domain.Entities.FocusOnFlyingDb.Dron", b =>
                {
                    ...
                    b.HasIndex("IdTypuDrona");

                    b.ToTable("Drony");
                });

            modelBuilder.Entity("FocusOnFlying.Domain.Entities.FocusOnFlyingDb.Faktura", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<bool>("ZaplaconaFaktura")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("FocusOnFlying.Domain.Entities.FocusOnFlyingDb.Usluga", b =>
                {
                    ...
                    b.HasIndex("IdFaktury")
                        .IsUnique()
                        .HasFilter("[IdFaktury] IS NOT NULL");
            ...
            modelBuilder.Entity("FocusOnFlying.Domain.Entities.FocusOnFlyingDb.Dron", b =>
                {
                    b.HasOne("FocusOnFlying.Domain.Entities.FocusOnFlyingDb.TypDrona", "TypDrona")
                        .WithMany("Drony")
                        .HasForeignKey("IdTypuDrona")
            ...
            modelBuilder.Entity("FocusOnFlying.Domain.Entities.FocusOnFlyingDb.Usluga", b =>
                {
                    b.HasOne("FocusOnFlying.Domain.Entities.FocusOnFlyingDb.Faktura", "Faktura")
                        .WithOne("Usluga")
                        .HasForeignKey("FocusOnFlying.Domain.Entities.FocusOnFlyingDb.Usluga", "IdFaktury");
