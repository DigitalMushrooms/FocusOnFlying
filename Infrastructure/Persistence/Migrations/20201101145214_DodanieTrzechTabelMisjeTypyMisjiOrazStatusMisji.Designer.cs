...
namespace FocusOnFlying.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20201101145214_DodanieTrzechTabelMisjeTypyMisjiOrazStatusMisji")]
    partial class DodanieTrzechTabelMisjeTypyMisjiOrazStatusMisji
    {
            ...
            modelBuilder.Entity("FocusOnFlying.Domain.Entities.FocusOnFlyingDb.Misja", b =>
                {
                    b.HasOne("FocusOnFlying.Domain.Entities.FocusOnFlyingDb.StatusMisji", "StatusMisji")
                        .WithOne("Misja")
                        .HasForeignKey("FocusOnFlying.Domain.Entities.FocusOnFlyingDb.Misja", "IdStatusuMisji")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("FocusOnFlying.Domain.Entities.FocusOnFlyingDb.TypMisji", "TypMisji")
                        .WithOne("Misja")
                        .HasForeignKey("FocusOnFlying.Domain.Entities.FocusOnFlyingDb.Misja", "IdTypuMisji")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
