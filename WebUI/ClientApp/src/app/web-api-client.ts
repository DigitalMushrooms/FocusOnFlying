...
export interface IDronyClient {
    ...
    zaktualizujDrona(id: string, patch: Operation[]): Observable<void>;
}
...
export class DronyClient implements IDronyClient {
    ...
    zaktualizujDrona(id: string, patch: Operation[]): Observable<void> {
        let url_ = this.baseUrl + "/api/drony/{id}";
        ...
        return this.http.request("patch", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processZaktualizujDrona(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processZaktualizujDrona(<any>response_);
                } catch (e) {
                    return <Observable<void>><any>_observableThrow(e);
                }
            } else
    ...
    protected processZaktualizujDrona(response: HttpResponseBase): Observable<void> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
...
export interface IFakturyClient {
    ...
    usunFakture(id: string): Observable<void>;
}
...
export class FakturyClient implements IFakturyClient {
    ...
    usunFakture(id: string): Observable<void> {
        ...
        return this.http.request("delete", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processUsunFakture(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processUsunFakture(<any>response_);
                } catch (e) {
                    return <Observable<void>><any>_observableThrow(e);
                }
            } else
    ...
    protected processUsunFakture(response: HttpResponseBase): Observable<void> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
...
export class MisjeClient implements IMisjeClient {
    ...
    zaktualizujMisje(id: string, patch: Operation[]): Observable<void> {
        ...
        return this.http.request("patch", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processZaktualizujMisje(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processZaktualizujMisje(<any>response_);
                } catch (e) {
                    return <Observable<void>><any>_observableThrow(e);
                }
            } else
...
export interface ITypyDronaClient {
    pobierzTypyDrona(): Observable<TypDronaDto[]>;
}

@Injectable({
    providedIn: 'root'
})
export class TypyDronaClient implements ITypyDronaClient {
    private http: HttpClient;
    private baseUrl: string;
    protected jsonParseReviver: ((key: string, value: any) => any) | undefined = undefined;
    ...
    pobierzTypyDrona(): Observable<TypDronaDto[]> {
        let url_ = this.baseUrl + "/api/typydrona";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processPobierzTypyDrona(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processPobierzTypyDrona(<any>response_);
                } catch (e) {
                    return <Observable<TypDronaDto[]>><any>_observableThrow(e);
                }
            } else
                return <Observable<TypDronaDto[]>><any>_observableThrow(response_);
        }));
    }

    protected processPobierzTypyDrona(response: HttpResponseBase): Observable<TypDronaDto[]> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        if (status === 200) {
            ...
            if (Array.isArray(resultData200)) {
                result200 = [] as any;
                for (let item of resultData200)
                    result200!.push(TypDronaDto.fromJS(item));
            }
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
        ...
        return _observableOf<TypDronaDto[]>(<any>null);
    }
}
...
export interface IUslugiClient {
    ...
    usunUsluge(id: string): Observable<void>;
}
...
export class UslugiClient implements IUslugiClient {
    ...
    pobierzMisjeUslugi(id: string, statusy: string[] | null | undefined, sort: string | null | undefined, offset: number | undefined, rows: number | undefined): Observable<PagedResultOfMisjaDto> {
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processPobierzMisjeUslugi(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processPobierzMisjeUslugi(<any>response_);
                } catch (e) {
                    return <Observable<PagedResultOfMisjaDto>><any>_observableThrow(e);
                }
            } else
    ...
    protected processPobierzMisjeUslugi(response: HttpResponseBase): Observable<PagedResultOfMisjaDto> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
    ...
    zaktualizujUsluge(id: string, patch: Operation[]): Observable<void> {
        let url_ = this.baseUrl + "/api/uslugi/{id}";
        if (id === undefined || id === null)
            throw new Error("The parameter 'id' must be defined.");
        url_ = url_.replace("{id}", encodeURIComponent("" + id));
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("patch", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processZaktualizujUsluge(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processZaktualizujUsluge(<any>response_);
                } catch (e) {
                    return <Observable<void>><any>_observableThrow(e);
                }
            } else
    ...
    protected processZaktualizujUsluge(response: HttpResponseBase): Observable<void> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
    ...
    usunUsluge(id: string): Observable<void> {
        ...
        return this.http.request("delete", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processUsunUsluge(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processUsunUsluge(<any>response_);
                } catch (e) {
                    return <Observable<void>><any>_observableThrow(e);
                }
            } else
    ...
    protected processUsunUsluge(response: HttpResponseBase): Observable<void> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
...
export class UslugaDto implements IUslugaDto {
    ...
    statusUslugi?: StatusUslugiDto | undefined;
    ...
    init(_data?: any) {
        if (_data) {
            ...
            this.statusUslugi = _data["statusUslugi"] ? StatusUslugiDto.fromJS(_data["statusUslugi"]) : <any>undefined;
